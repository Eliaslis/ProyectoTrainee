...
public class MenuAlumno extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(btn_materias, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 210, 110, -1));

        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/light-cyber-space-4k-uhd-3d-illustration-background-free-photo.jpg"))); // NOI18N
        jLabel1.setText("jLabel1");
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 630, 450));

        jMenu1.setText("Sesión");

        menu_cerrar.setText("Cerrar Seión");
